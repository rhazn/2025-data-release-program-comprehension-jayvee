...
interface Task1PagePYProps {}

export const Task1PagePY: FC<Task1PagePYProps> = ({}: Task1PagePYProps) => {
    ...
    const checkSolution = () => {
        const correctSolutions = ["2:4,0:2", "2:4, 0:2"];
                ...
                <div className="flex flex-1 justify-center self-start">
                    <table className="border border-solid border-black p-2 border-collapse">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td className="bg-blue-100 border border-solid border-black p-1">
                                    Datsun 710
                                </td>
                                <td className="bg-blue-100 border border-solid border-black p-1">
                                    22.8
